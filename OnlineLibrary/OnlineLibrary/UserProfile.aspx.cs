    ...
    public partial class UserProfile : System.Web.UI.Page
    {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update Users set fullName=@full_name, dob=@dob, phoneNumber=@contact_no, email=@email, state=@state, city=@city, pincode=@pincode, address=@full_address, password=@password, accountStatus=@account_status WHERE username='" + Session["username"].ToString().Trim() + "'", con);
        ...
        void getUserBookData()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from BookIssue where username='" + Session["username"].ToString() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
