<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="AdminAuthorManagment.aspx.cs" Inherits="OnlineLibrary.AdminAuthorManagment" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                       <img width="100px" src="img/author-sign.png" />
                                </center>
                            </div>
                        </div>
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CorpusLibraryDBConnectionString %>" SelectCommand="SELECT * FROM [Authors]"></asp:SqlDataSource>
                            <div class="col">
